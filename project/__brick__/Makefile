...
check: format_code
	...
	@echo "\033[32m Sort imports... \033[0m"
	...
	@fvm flutter pub run dart_code_metrics:metrics check-unused-files . --fatal-unused --exclude="{.fvm/**,ios/**,tools/**,.dart_tool/**,lib/generated/**}"
